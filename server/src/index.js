...
server.listen(port, () => console.log(`API + chat + maps + agro ML + Live GPS AI tourism + MapLibre 3D buildings + secure OTP consent v1.5.0 on Node 22 listening on http://localhost:${port}`));
