...
app.get('/health', (_req, res) => res.json({ ok: true, version: '1.5.1' }));
...
server.listen(port, () => console.log(`API + chat + maps + agro ML + Live GPS AI tourism + MapLibre 3D buildings + hardened OTP onboarding v1.5.1 on Node 22 listening on http://localhost:${port}`));
