...
app.get('/health', (_req, res) => res.json({ ok: true, version: '1.4.2' }));
...
server.listen(port, () => console.log(`API + chat + maps + agro ML + Live GPS AI tourism + MapLibre 3D buildings v1.4.2 on Node 22 listening on http://localhost:${port}`));
