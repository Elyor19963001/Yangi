    ...
    root.querySelectorAll?.('.assistant-mascot .mascot-layered').forEach(layer=>{
      ...
      if(hand&&typeof hand.animate==='function'){
        ...
        hand.animate([
          ...
          {transform:'rotate(0deg)',offset:.28},
          {transform:'rotate(-3deg)',offset:.36},
          {transform:'rotate(2.6deg)',offset:.44},
          {transform:'rotate(-2deg)',offset:.52},
          {transform:'rotate(1.2deg)',offset:.59},
          {transform:'rotate(0deg)',offset:.66},
      ...
      if(head&&typeof head.animate==='function'){
        ...
        head.animate([
          ...
          {transform:'translateY(-.12px) rotate(.20deg)',offset:.34},
          {transform:'translateY(0) rotate(-.16deg)',offset:.60},
          {transform:'translateY(-.08px) rotate(.10deg)',offset:.78},
